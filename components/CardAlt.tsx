...
function CardAlt({
	...
	return (
		<div className="inline-flex w-full overflow-hidden flex-col bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
			...
			{/* <Carousel className="rounded-none" slide={false}>
				{imagesUrl.map((e) => (
					<div key={e} className="relative h-48 rounded-none">
			...
			<div className=" p-3 py-2 gap-y-1 flex flex-col justify-between ">
