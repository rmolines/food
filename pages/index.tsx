			...
			<div className="gap-8 items-center flex">
				<div className="mt-4 md:mt-0">
					...
					<p className="mb-6 font-light text-gray-500 dark:text-gray-400">
						...
						antigos de maneira organizada e estruturada. Com
						Innfluenced, seus seguidores terão um acesso muito mais
						rico e organizado para interagir com seu conteúdo.
					</p>
					<label
